...
//       await axios.post(
//         "https://testomate-backend-bubwewfpd2c4a7a0.southindia-01.azurewebsites.net/api/jira/history/draft",
//         {
//           projectKey,
//           type: tab,
//           title,
...
//           "https://testomate-backend-bubwewfpd2c4a7a0.southindia-01.azurewebsites.net/api/jira/createIssue",
//           {
//             projectKey,
//             title,
//             description,
...
//         }
//         const response = await axios.post(
//           "https://testomate-backend-bubwewfpd2c4a7a0.southindia-01.azurewebsites.net/api/jira/issue",
//           {
//             projectKey,
//             type: tab,
//             title,
...
export default function RequirementsPage() {
  ...
  // Save generated content to cache when it changes
  useEffect(() => {
    if (projectKey) {
      if (!projectContentCache[projectKey])
        projectContentCache[projectKey] = {};
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center">
              ...
              <div className="text-lg font-semibold text-gray-700">
                Generating all results, please wait...
              </div>
            </div>
          </div>
        )}
              ...
              <div className="p-6">
                ...
                <div className="flex items-center text-sm text-gray-500 mb-6">
                  <Link
                    to="/home"
                    className={`font-medium text-[#343434] cursor-pointer ${
                      isGeneratingAll ? "pointer-events-none opacity-50" : ""
                    }`}
                  >
                    Home
                  </Link>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="p-6">
                      <div className="min-h-[400px]">
                        {generationLoading[activeGenerationTab] && !isGeneratingAll ? (
                          <div className="flex items-center justify-center h-40 text-gray-500">
                            Generating...
                          </div>
                        ) : generationErrors[activeGenerationTab] ? (
